...
-record(elf_phdr, {
    type    :: load | dynamic | interp | note | tls
             | phdr | gnu_eh_frame | gnu_stack | gnu_relro
...
-record(elf_shdr, {
    ...
    name      :: binary(),
    type      :: null | progbits | symtab | strtab | rela | hash
               | dynamic | note | nobits | rel | dynsym
               | init_array | fini_array | {unknown, non_neg_integer()},
